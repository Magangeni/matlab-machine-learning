...
% Last Modified by GUIDE v2.5 24-Sep-2016 17:30:06
...
% Hint: get(hObject,'Value') returns toggle state of sinusoid
...
function undampedNatFreq_Callback(hObject, eventdata, handles)
% hObject    handle to undampedNatFreq (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of undampedNatFreq as text
%        str2double(get(hObject,'String')) returns contents of undampedNatFreq as a double


% --- Executes during object creation, after setting all properties.
function undampedNatFreq_CreateFcn(hObject, eventdata, handles)
% hObject    handle to undampedNatFreq (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
...
function pulseEnd_Callback(hObject, eventdata, handles)
